package com.mamits.apnaonlines.ui.customviews;
...
public class CustomCircularImageView extends ImageView {
    ...
    public CustomCircularImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CustomCircularImageView, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(R.styleable.CustomCircularImageView_civ_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CustomCircularImageView_civ_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.CustomCircularImageView_civ_border_overlay, DEFAULT_BORDER_OVERLAY);
        mCircleBackgroundColor = a.getColor(R.styleable.CustomCircularImageView_civ_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
